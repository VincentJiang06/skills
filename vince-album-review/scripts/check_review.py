...
# intent; gear -> vince-hifi-review; bare lyric translation / buying advice -> out.
...
def classify_route(prompt):
    """Return one of: 'album-review' | 'vince-hifi-review' | 'out-of-scope'."""
    if _HIFI.search(prompt):
        return "vince-hifi-review"
