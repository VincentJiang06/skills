...
- **No provenance inflation**: do not describe a consensus technicality (声场/结像/
  解析/动态/瞬态/音色) as 测量背书 / measurement-backed — a measurement lab's
  *subjective* stage/detail opinion is still subjective. Measurement backs only the
  FR-derived 量感/风格 and bench metrics; cite measuring reviewers for their
  impressions, not as measured corroboration of a technicality.
