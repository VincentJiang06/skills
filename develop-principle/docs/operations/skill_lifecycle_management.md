...
reference_ids: `ref.open_agent_skills.specification`, `ref.skills_re.registry`, `ref.skillsvote.lifecycle_governance`, `ref.skilldex.package_registry`, `ref.secure_agent_skills.lifecycle_threats`, `ref.opentelemetry.genai_agent_spans`, `ref.openai.agents_tracing`, `ref.langsmith.observability`, `ref.semver`, `ref.google_sre.canarying`, `ref.openfeature.feature_flags`

node_ids: `pillar.lifecycle`, `concept.skill_release_manifest`, `procedure.release_gate`, `procedure.rollback_plan`, `procedure.deprecation_policy`, `procedure.evidence_gated_update`, `pattern.skill_registry`, `metric.rollback_readiness`, `metric.lifecycle_trace_coverage`
