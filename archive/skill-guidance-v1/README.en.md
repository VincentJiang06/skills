...
**Why it's good** —
- A **7-pillar readiness scorecard** grounded in the `skill-principle` KB tells you whether a skill is "industrial," what's missing, and how much.
...
**Install** — `npx skills add VincentJiang06/skills` (or `cp -R skills/skill-guidance ~/.claude/skills/`). The `skill-principle/` KB is embedded in this skill folder and installs with `skill-guidance`.
